...
//$graph->title->SetFont(CHINESE_TTF_FONT,bsmi001p);
$graph->SetTitles(array("¤£¶}¤ß","Two","Three","Four","Five","Sex","Seven","Eight","Nine","Ten"));
		
//$plot = new RadarPlot(array(12,35,20,30,33,15,37));
$plot = new RadarPlot(array(12,20,25,30,35,45,55));
