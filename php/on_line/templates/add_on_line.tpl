...
<font size="4" color="#0066FF"><b>課程連結：<input type="radio" name="style" value="link"><input type="text" name="url" size="37" value="LINK" onFocus="addonline.style[0].checked=true"></b></font><br>
<font size="4" color="#0066FF"><b>影像RM檔：<input type="radio" name="style" value="upload"></b><INPUT TYPE="FILE" NAME="file" SIZE="28" onFocus="addonline.style[1].checked=true"></font><br>
<font color="#777777">請選擇欲上傳的隨選視訊檔案(rm檔)</font><br><br>
...
<font color="#777777">請寫出完整的rm檔路徑(如pnm://myserver/abc.rm)</font><br><br>
