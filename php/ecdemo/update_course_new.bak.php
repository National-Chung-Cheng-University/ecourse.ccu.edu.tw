...
{	
	...
	*/
	...
	$Q53 = "CREATE TABLE qa2 ( tiku_a_id int(11) NOT NULL default '0', `exam_id` int(11) NOT NULL default '0', `student_id` int(11) NOT NULL default '0', `type` tinyint(4) NOT NULL defa
ult '1', `ismultiple` char(1) NOT NULL default '', `stu_ans_1` text NOT NULL, `stu_ans_2` text NOT NULL, `stu_ans_3` text NOT NULL, `stu_ans_4` text NOT NULL, `mtime` timestamp(14) NOT NULL, KEY `t
iku_a_id` (`tiku_a_id`,`exam_id`,`student_id`))";
