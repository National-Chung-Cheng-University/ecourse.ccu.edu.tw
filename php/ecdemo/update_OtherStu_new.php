...
<?php
  ...
  if( ( $time >= '01-01' and $time <= '03-31') or ( $time >= '09-01' and $time <= '10-30') )
  {
    ...
    //取得學籍系統校際選課生資料---一般生資料庫
		...
		//$cur1 = sybase_query("select std_no, cour_grp, name, sch_name from a31vcurriculum_other where year='$year' and term='$term' and std_no<> '400335910' order by std_no", $cnx1);
		//if(!$cur1) {  
