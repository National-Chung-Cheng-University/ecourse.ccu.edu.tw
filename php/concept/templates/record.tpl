...
<body >
<br><center>
<form method="post" action="./record.php" target="html">
<input type="hidden" value="AID" name="a_id">
<input type="hidden" value="record" name="action">
<input type="hidden" value="PHPID" name="PHPSESSID">
...
<tr>
<td bgcolor="#F0FFEE"> 
<font size="4" color="#0066FF"><b>概括(定義)：<br><textarea name="contain" rows = 4 cols=38>TEXT1</textarea></b></font><br>
</td>
</tr>
</table>
</td>
...
<tr>
<td bgcolor="#F0FFEE"> 
<font size="4" color="#0066FF"><b>比較：<br><textarea name="compare" rows = 4 cols=38>TEXT2</textarea></b></font><br>
</td>
</tr>
</table>
</td>
...
<tr>
<td bgcolor="#F0FFEE"> 
<font size="4" color="#0066FF"><b>列舉：<br><textarea name="list" rows = 4 cols=38>TEXT3</textarea></b></font><br>
</td>
</tr>
</table>
</td>
