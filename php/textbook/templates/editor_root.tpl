...
function check_chap_num() {
	if (document.getElementById("chap_num").value == '0') {
		alert("請由第一章開始輸入.");
		return false;
	} else 
		return true;
...
<tr bgcolor=#cdeffc>
	<td>章數<input type="text" name="chap_num" id="chap_num" size=4>
	<td>標題<input type="text" name="chap_title" size=50>
	<td></td></tr>
</table>

<input type="hidden" name="action" value=1>
<input type="submit" name="submit" value="新增/更新章標題" onclick="return check_chap_num();"><input type="reset" name="reset" value="重新輸入">
</form>
<hr>
