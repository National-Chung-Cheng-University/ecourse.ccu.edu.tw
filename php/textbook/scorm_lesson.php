<?
	...
	$Q1 = "select tc.credit from user u, take_course tc where u.id='$user_id' and u.a_id = tc.student_id and tc.course_id = '$course_id' and tc.year='$course_year' and tc.term='$course_term'";
