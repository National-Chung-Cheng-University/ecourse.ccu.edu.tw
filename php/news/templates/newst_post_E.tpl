...
<font size="2"><a href="#newst">‧Back to Top‧<br><br></a></font> 
<table border="0" cellspacing="1" cellpadding="5">
<form name=chpage method=POST action=./news.php>
<input type=hidden name=views value="VIEWS">
<tr bgcolor="#000066">
<td><div align="center"><font color="#FFFFFF" size="2">News Style：<select name="style" onChange="gotoPage();">
<option value="0" >Generic</option>
<option value="1" >Have Limit</option>
<option value="2" selected>Have Cycle</option>
</select>
</font></div>
HIDDEN1
</td>
...
<td><div align="center"><font color="#FFFFFF" size="2">Begin Date：<select name="start_y">
...
<td><div align="center"><font color="#FFFFFF" size="2">End Date：<select name="end_y">
...
<tr bgcolor="#000066">
<td COLSPAN=3><div align="center"><font color="#FFFFFF" size="2">Cycle Set： 
<select name="T_y">
...
<select name="T_m">
<option value="00" TM00>Every Month of Year</option>
...
<select name="T_d">
<option value="00" TD00>Every Day of Month</option>
...
<select name="T_w">
<option value="00" TW00>Every Day of Week</option>
<option value="07" TW06>Only Sun.</option>
<option value="01" TW01>Only Mon.</option>
<option value="02" TW02>Only Thu.</option>
<option value="03" TW03>Only Wed.</option>
<option value="04" TW04>Only The.</option>
<option value="05" TW05>Only Fri.</option>
<option value="06" TW06>Only Sat.</option>
</select>
</td>
</tr>
<tr bgcolor="#000066">
<td COLSPAN=2><div align="center"><font color="#FFFFFF" size="2">If Passed： 
<select name="handle">
<option value="0" H0>Delete</option>
<option value="1" H1>Keep but Not Show</option>
</select>
</td>
<td><div align="center"><font color="#FFFFFF" size="2">Priority： 
...
<tr bgcolor="#000066">
<td COLSPAN=3><div align="center"><font color="#FFFFFF" size="2">News Subject： 
<input type="text" name="subject" maxlength="100" value="SUB"></font></div>
</td>
</tr>
<tr> 
<td colspan="3"> 
<div align="center"><font size="2"><br>News Content：<br>
