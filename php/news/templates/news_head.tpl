...
function Vlimit()
{
	parent.options.msgwin('資料處理中, 請稍候..');
...
<tr><td>
瀏覽時間：<select name="year" onChange="Vdate();">
...
DELETE
<TD> 
<div align="center"><a href="./news.php?views=2&order=1&month=MONT&year=YEARV"><FONT color=#ffffff size=2>日期</FONT></a></div></TD>
<td>
<div align="center"><a href="./news.php?views=2&order=3&month=MONT&year=YEARV"><FONT color=#ffffff size=2>公告重要等級</font></a></div></td>
<TD> 
<div align="center"><FONT color=#ffffff size=2>標題及詳文連結</FONT></div></TD>
<TD COLSPAN=2> 
<div align="center"><a href="./news.php?views=2&order=7&month=MONT&year=YEARV"><FONT color=#ffffff size=2>瀏覽次數</FONT></a></div></TD>
</TR>