...
// param : course_id (session)
	...
	$sql = "select * from mid_question where block_id = '0' and type = '3' and q_id ='$q_id' order by a_id";
	...
	if(mysql_num_rows($result) > 0) {
		...
		while($row = mysql_fetch_array($result)) {
			...
			//產生節的選項
			$sql2 = "select * from mid_question where block_id = '$block' and type != 3 and q_id ='$q_id' order by a_id";
