...
<p>
<img src=/images/img/a65.gif>
<p>
<BR>
<center>
<font color=#ff0000>MESSAGE</font>
<!--<form method=POST action=give_pass1.php>-->
...
<tr bgcolor="#000066" ><th><font color = "#FFFFFF">學號</font></th><th><font color = "#FFFFFF">密碼</font></th></tr>
<!-- BEGIN DYNAMIC BLOCK: row -->
<tr bgcolor=COLOR>
<td>STUDENT_ID</td>
<td><input type=text name=id[STUDENT_ID] value="PASSWORD" size=11></td>
</tr>
...
<!--<input type=submit value=更新>　　<input type=reset value=清除>
</form> 
-->
</center>
</BODY>
