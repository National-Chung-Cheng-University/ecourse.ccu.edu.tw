...
<tr bgcolor="#000066" ><th><font color = "#FFFFFF">Name</font></th><th><font color = "#FFFFFF">ID</font></th></tr>
...
<input type=submit value=Modify  onclick="MsgWin();">　　<input type=reset value=Reset>
</form>
</center>
</BODY>
</HTML>
