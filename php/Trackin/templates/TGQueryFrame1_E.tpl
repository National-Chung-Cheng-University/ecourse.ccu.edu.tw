...
<th> 
<div align="center"><a href="./TGQueryFrame1.php"><font color="#FFFFFF" size="2">Student ID</font></a></div>
</th>
<th> 
<div align="center"><a href="./TGQueryFrame1.php?sel=name"><font color="#FFFFFF" size="2">Name</font></a></div>
</th>
<!-- BEGIN DYNAMIC BLOCK: row -->
<th><font color = "#FFFFFF" size="2">TESTNAME (RATIO%)</font></th>
<!-- END DYNAMIC BLOCK: row -->
<th><a href=TGQueryFrame1.php?sel=Total><font color = "#FFFFFF" size="2">Total Score</font></a></th></tr>
