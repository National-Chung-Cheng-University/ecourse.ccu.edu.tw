...
function loadSavedScore() {
        window.location = "/php/Trackin/TGShowFrame2.php?loadtemp=1#!OTHER_PARAMS!#";
}
...
<input type=hidden  name=action value=upload_excel2>
<input type=hidden  name=course value="COUID">
<input type=submit  value="上傳期末總成績Excel檔">
</form>
</td></tr>
</table>
<form name="form1" action="TGUpload2.php" method="post" target="_blank">
<p align="center" class="style4">學期成績列表</p>
<a href="./../Courses_Admin/teach_course.php">回到開課列表</a>
...
<p><span class="style1">注意！</span><span class="style1"><span class="style5">成績可分批次上傳但每位學生成績資料僅限上傳一次</span>，</span><span class="style1"><span class="style5">一經上傳不得更改，</span><br>
      學生休、退學、棄選紀錄請以系統為主；非以上情況者，均應給予成績。<br>
