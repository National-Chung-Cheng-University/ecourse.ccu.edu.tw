...
<p align="center"> <font size="2"><font color="#000000">Create Grade</font></font></p>
<center>
<form method="POST" action="./TGInsertFrame1.php">
...
<td> 
<div align="center"><font color = "#FFFFFF">Student ID</font></div>
</td>
<td> 
<div align="center"><font color = "#FFFFFF">Score</font></div>
</td>
...
<input type=submit name=Submit value=Sure>   <input type=reset name=Reset value=Reset>
