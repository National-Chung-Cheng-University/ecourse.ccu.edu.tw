...
<td >　</td>
<td>
<p align="left">　<img src="/images/arrow_ltr.gif"><input type="submit" value="SHARE" name="submit" onClick="return check(selected,1);"><input type="submit" value="NOT_SHA" name="submit" onClick="return check(selected,2);"><input type="submit" value="DELETE" name="submit" onClick="return check(selected,3);"><input type="reset" value="CLEAR" name="clear"></p>
</td>
<td >　</td>
</tr>
</table></form>
