...
<table border="0" align="center" cellpadding="0" cellspacing="0" width="30%">
<tr> 
<td> 
...
<tr bgcolor="#000066" align="center"><th><font color="#FFFFFF">Status</font></th></tr>
<tr bgcolor="#D0DFE3"><td>STATUS</td></tr>
</table>
</td>
<td height=10> 
...
<td bgcolor="#CCCCCC"> 
<table border=0 align="center" width="100%" cellpadding="3" cellspacing="1">
<tr bgcolor="#000066" align="center"><th><font color="#FFFFFF">Name</font></th><th><font color="#FFFFFF">Beginning Time</font></th><th><font color="#FFFFFF">During Time</font></th></tr>
<tr bgcolor="#D0DFE3"><td>TESTNAME</td>
<td><select name=sel_year size=1>
...
<td><input type=radio CHECK1 name=range value=1>1 hour
<input type=radio CHECK2 name=range value=2>2 hours
<input type=radio CHECK3 name=range value=4>4 hours
<input type=radio CHECK4 name=range value=8>8 hours
</td></tr>
<tr bgcolor="#000066" ><th><font color="#FFFFFF">Public by Hands</font></th><th><font color="#FFFFFF">Dead Line</font></th><th><font color="#FFFFFF">Status</font></th></tr>
<tr bgcolor="#D0DFE3"><td><input type=checkbox name=pub value=1 PUB></td>
<td><select name=ed_year size=1>
...
<BR>
<input type=submit name=sure value=OK>
<input type=submit name=sure value="Not Public">
<input type=hidden name=exam_id value=EXAMID>
<input type=hidden name=action value=modifypubtest>
</form>
</center>
</BODY>
</HTML>