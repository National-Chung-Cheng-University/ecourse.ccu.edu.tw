<?php /* Smarty version 2.6.14, created on 2011-03-08 08:09:50
         compiled from /usr/local/apache/htdocs/php/Mmc/templates/listTodayMeeting.tpl */ ?>
...
?>
      <tr>
          ...
          <td bgcolor="#F0FFEE"><?php if ($this->_tpl_vars['meetingData']['recording'] == 1): ?>是<?php else: ?>否<?php endif; ?></td>
...
'>取消</a></td>
    ...
    <p align="center">
    今日的會議預約時間還沒有到，您也可以選擇先進入"準備模式"，<br>
    ...
    <p align="center">若您只是想開一個即時會議，可以<a href='./instanceMeeting.php'>   按這裡就馬上開一個即時會議</a></p></caption>
