<?php /* Smarty version 2.6.14, created on 2011-03-10 21:46:46
         compiled from /usr/local/apache/htdocs/php/Mmc/templates/reservationMeeting.tpl */ ?>
...
{
  // 先把收尋功\能拿掉，需要的話把下一行的註解取消，收尋功\能還沒做
  // $("#searching").show();
    ...
    <tr>
      ...
      <td bgcolor="#CCCCCC" height="100%">  
        <table cellpadding=2 align=center border=0 bordercolorlight="#666666" bordercolordark="#FFFFFF" width="100%" cellspacing="1">
          <tr align=center>
             <th colspan="2" bgcolor="#E6FFFC">請設定預約會議的屬性:<br>*必填欄位</th>
          </tr>
             <tr align=center>
             <th bgcolor="#F0FFEE">* 接續會議:</th>
             <td bgcolor="#F0FFEE">
...
"></td>
          ...
          <tr align=center>
	       ...
	       <br><a href="listWeekReservationMmc.php">課表模式</a>             
             </td>
           </tr>
           <tr align=center>
             <th bgcolor="#E6FFFC">*時間長度:</th>
             <td bgcolor="#E6FFFC">
               <select name="duration" >
                  <option value="900">15分鐘</option><option value="1800" <?php if ($this->_tpl_vars['duration'] == 1800): ?>selected<?php endif; ?>>30分鐘</option>
                  <option value="2700">45分鐘</option><option value="3600" <?php if ($this->_tpl_vars['duration'] == 3600): ?>selected<?php endif; ?>>1小時</option>
                  <option value="4500">1小時15分鐘</option><option value="5400" <?php if ($this->_tpl_vars['duration'] == 5400): ?>selected<?php endif; ?>>1小時30分鐘</option>
                  <option value="6300">1小時45分鐘</option><option value="7200" <?php if ($this->_tpl_vars['duration'] == 7200): ?>selected<?php endif; ?>>2小時</option>
                  <option value="8100">2小時15分鐘</option><option value="9000" <?php if ($this->_tpl_vars['duration'] == 9000): ?>selected<?php endif; ?>>2小時30分鐘</option>
                  <option value="9900">3小時45分鐘</option><option value="10800" <?php if ($this->_tpl_vars['duration'] == 10800): ?>selected<?php endif; ?>>3小時</option>
               </select>
            </td>
          </tr>
          <tr align=center>
...
">
         ...
         <tr align=center>
          <th bgcolor="#F0FFEE">議程/留言:</th>
          <td bgcolor="#F0FFEE">
              <textarea name="agenda" rows="8" cols="40"></textarea>
          </td>
        </tr>
        <tr align=center>
          <th bgcolor="#E6FFFC">寄信邀請:</th>
          <td bgcolor="#E6FFFC">
