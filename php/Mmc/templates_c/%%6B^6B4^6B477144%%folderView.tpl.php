<?php /* Smarty version 2.6.14, created on 2010-09-11 17:12:18
         compiled from /home/opera/WWW/themes/IE2/mmc/folderView.tpl */ ?>
...
您要求在" <?php echo $this->_tpl_vars['folderName']; ?>
 "資料夾下<br>建立一個新資料夾。<br>
<?php elseif ($this->_tpl_vars['funcFolder'] == "重新命名資料夾"): ?>
您要求重新命名"<?php echo $this->_tpl_vars['folderName']; ?>
 "資料夾。<br>
<?php else: ?>
<font color="red">您確定要刪除" <?php echo $this->_tpl_vars['folderName']; ?>
 "資料夾？<br><br>
