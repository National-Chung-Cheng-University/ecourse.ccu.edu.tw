      ...
      <td bgcolor="#CCCCCC" height="100%">  
        <table cellpadding=2 align=center border=0 bordercolorlight="#666666" bordercolordark="#FFFFFF" width="100%" cellspacing="1">
          ...
          <tr align=center>
             ...
             <td bgcolor="#E6FFFC"><input type="text" name="title" size="30" value="{$temptitle}"></td>
          </tr>
          <tr align=center>
           ...
           <tr align=center>
             ...
             <td bgcolor="#E6FFFC">
               <select name="duration" >
                  <option value="900">15分鐘</option><option value="1800" {if $duration == 1800}selected{/if}>30分鐘</option>
                  <option value="2700">45分鐘</option><option value="3600" {if $duration == 3600}selected{/if}>1小時</option>
                  <option value="4500">1小時15分鐘</option><option value="5400" {if $duration == 5400}selected{/if}>1小時30分鐘</option>
                  <option value="6300">1小時45分鐘</option><option value="7200" {if $duration == 7200}selected{/if}>2小時</option>
                  <option value="8100">2小時15分鐘</option><option value="9000" {if $duration == 9000}selected{/if}>2小時30分鐘</option>
                  <option value="9900">3小時45分鐘</option><option value="10800" {if $duration == 10800}selected{/if}>3小時</option>
               </select>
            </td>
          </tr>
          <tr align=center>
          ...
          <tr align=center>
            ...
            <td bgcolor="#E6FFFC">
              預設連線數為全班學生數 + 老師 + 5<br>
              <input type="text" name="connectionCount" size="5" value="{$tempconnectionCount}">
            </td>
         </tr>
         <tr align=center>
