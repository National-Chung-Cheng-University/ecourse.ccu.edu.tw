...
//require_once './yuwan/test1029.php';
//require_once './yuwan/preprocess.php';
//require_once './preprocess.php';
$year=100;
$count=0;
$Q = "select 1_1,1_2,1_3,2_1,2_2,2_3,3_1,3_2,3_3,4_1,4_2 from IEEE_Results where id = '$user_id' and year <= '$year' ";

//$Q = "select 1_1,1_2,1_3,2_1,2_2,2_3,3_1,3_2,3_3,4_1,4_2 from IEEE_Results where id = '699410097' and year <= '98' ";
