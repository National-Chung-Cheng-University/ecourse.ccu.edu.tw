...
<tr bgcolor=#F0FFEE align=center>
  <td bgcolor="#E6FFFC" >Chapter：
    <select  name=chap_num>
        SELECT_CHAP
    </select>
<br>
(0:Don't assignment chapter) </td>
</tr>
<tr bgcolor=#000066 align=center> 
<td bgcolor="#E6FFFC" > 
<div align="center">
Please Input Homework Name：
...
<tr bgcolor="#F0FFEE"> 
<td align=left> 
<div align="center">Please Input Dead Line：
<input type="text" name="work_due" size="15" value="WORKDUE">
<br>
<font color=#000080>(xxxx-xx-xx;Year-Month-Day)</font></div>
</td>
</tr>
<tr bgcolor="#E6FFFC"> 
<td align=left bgcolor="#E6FFFC"> 
<div align="center">Please Input Ratio： 
...
<td align=left> 
<div align="center">
<input type="submit" name="submit1" value="Sure">
