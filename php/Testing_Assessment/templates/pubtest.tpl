...
<tr bgcolor="#000066" align="center"><th><font color="#FFFFFF">現在狀態</font></th></tr>
...
<td bgcolor="#CCCCCC"> 
<table border=0 align="center" width="100%" cellpadding="3" cellspacing="1">
<tr bgcolor="#000066" align="center"><th><font color="#FFFFFF">考試名稱</font></th><th><font color="#FFFFFF">考試開始時間</font></th><th><font color="#FFFFFF">考試時間長度</font></th></tr>
...
<td><input type=radio CHECK1 name=range value=1>一小時
<input type=radio CHECK2 name=range value=2>兩小時
<input type=radio CHECK3 name=range value=4>四小時
<input type=radio CHECK4 name=range value=8>八小時
</td></tr>
<tr bgcolor="#000066" ><th><font color="#FFFFFF">手動發佈</font></th><th><font color="#FFFFFF">考試結束時間</font></th><th><font color="#FFFFFF">狀態</font></th></tr>
