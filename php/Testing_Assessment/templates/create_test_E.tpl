...
<div align="center">Please Choose the Test Type： 
<select size=1 name=test_type>
<option value=self_test SELF_TEST>Self-test</option>
<option value=real_test REAL_TEST>Normal-test</option>
</select>
</div>
</td>
</tr>
...
<p><a href="./import_test.php" >Import Test</a></p>
</center>
</BODY>
