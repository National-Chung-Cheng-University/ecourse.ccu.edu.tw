...
<td><font color=#FFFFFF>作業名稱</font></td><td><font color=#FFFFFF>學號</font></td><td><font color=#FFFFFF>欣賞作業</font></td></tr>
<!-- BEGIN DYNAMIC BLOCK: row -->
<tr><td>WORKNAME</td><td>SNAME</td>
<form method=POST action=show_allwork.php><td>
<input type=hidden name=sid value=SNO>
<input type=hidden name=work_id value=WORKID>
<input type=hidden name=action value=showgoodwork>
<input type=submit value=觀看內容>
</td></form>
</tr>
