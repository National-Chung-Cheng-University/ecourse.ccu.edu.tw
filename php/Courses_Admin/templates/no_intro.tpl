...
總共有 TOTAL 門課<br>
STATUS的有 <font color=red>INTRO</font> 門<br>
PERCENT
<form action=./no_intro.php name=show method=get target="_top">
...
<!-- BEGIN DYNAMIC BLOCK: no_intro_list -->
...
SELF
<!-- END DYNAMIC BLOCK: no_intro_list -->
</table>
</td>
    <td>
