...
function add_student()
{
	...
	$Q0 = "select student_id, course_id from take_course where credit=1 order by student_id";
	...
	while ($row0 = mysql_fetch_array($result0))
	{
		...
		$Q1 = "select course_no from course_no where course_id='".$row0[course_id]."'";
