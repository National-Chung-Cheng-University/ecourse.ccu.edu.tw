...
require 'fadmin.php';
	if (!(isset($PHPSESSID) && session_check_stu($PHPSESSID)) ) {
		...
		if ( $row['authorization'] == "4" ) {
			...
			{
				$content="";
				if ( is_file("../../old_intro/$year/$term/$id/index.html") ) {
						$fp = fopen("../../old_intro/$year/$term/$id/index.html", "r");
						$content = fread($fp , filesize("../../old_intro/$year/$term/$id/index.html"));
						fclose($fp);

				}
				else if ( is_file("../../old_intro/$year/$term/$id/index.htm") ) {

						$fp = fopen("../../old_intro/$year/$term/$id/index.htm", "r");
						$content = fread($fp , filesize("../../old_intro/$year/$term/$id/index.htm"));
						fclose($fp);;
				}
				else if ( is_file("../../old_intro/$year/$term/$id/index.doc") ){
					//global $check, $version, $course_id, $teacher;
					$content = "<HTML>\n<HEAD>\n<TITLE>授課大綱</TITLE>\n".
								"<META HTTP-EQUIV=REFRESH CONTENT=\"0;URL=../../old_intro/$year/$term/$id/index.doc\">\n".
								"</HEAD>\n</HTML>";	
				}
				else if ( is_file("../../old_intro/$year/$term/$id/index.pdf") ){
					//global $check, $version, $course_id, $teacher;
					$content = "<HTML>\n<HEAD>\n<TITLE>授課大綱</TITLE>\n".
								"<META HTTP-EQUIV=REFRESH CONTENT=\"0;URL=../../old_intro/$year/$term/$id/index.pdf\">\n".
								"</HEAD>\n</HTML>";
				}
				else if (is_file("../../old_intro/$year/$term/$id/index.ppt"))
				{
					//global $check, $version, $course_id, $teacher;
					$content = "<html>\n<head>\n<title>授課大綱</title>\n".
								"<meta http-equiv=REFRESH content=\"0;url=../../old_intro/$year/$term/$id/index.ppt\">\n".
								"</head>\n</html>";	
				}
				else {
	...
	function show_page_d ( $message="" ){
		...
		//取出選出的學年度的課程
		//如果是當學期
		if(($row0['year']==$row01['year'] && $row0['term']==$row01['term']) || ($row0['year']=="" && $row0['term']=="")){
			if ( $version == "C" ) {
			...
			if ( $result2 = mysql_db_query( $DB, $Q2 ) ) {
				while($row2 = mysql_fetch_array( $result2 ))
				{
					...
					if ( $result3 = mysql_db_query( $DB, $Q3 ) ) {
						...
						if( $row3[introduction]!= "" || is_file("../../$row2[course_id]/intro/index.html") || is_file("../../$row2[course_id]/intro/index.htm") || is_file("../../$row2[course_id]/intro/index.doc") || is_file("../../$row2[course_id]/intro/index.pdf") || is_file("../../$row2[course_id]/intro/index.ppt") )
						{
							$color = "#E6FFFC";
							$fontcol = "black";
							//抓取檔案時間
			...
			if ( $result2 = mysql_db_query( $DB, $Q2 ) ) {
				...
				while($row2 = mysql_fetch_array( $result2 ))
				{
					...
					//學年資料夾 93,94,...
					if(!is_dir("../../old_intro/".$row2[year]))
					{
						mkdir("../../old_intro/".$row2[year], 0700);//建立目錄
					}
					//學期資料夾 1,2
					if(!is_dir("../../old_intro/".$row2[year]."/".$row2[term]))
					{
						mkdir("../../old_intro/".$row2[year]."/".$row2[term], 0700);//建立目錄				
					}	
					//課程資料夾 course_id
					if(!is_dir("../../old_intro/".$row2[year]."/".$row2[term]."/".$row2[course_id]))
					{
						mkdir("../../old_intro/".$row2[year]."/".$row2[term]."/".$row2[course_id], 0700);//建立目錄
					}					
					//判斷是否有課程大綱
					...
					if ( $result3 = mysql_db_query( $DB, $Q3 ) ) {
						...
						if(is_file("../../echistory/$row2[year]/$row2[term]/$row2[course_id]/index.html") || is_file("../../echistory/$row2[year]/$row2[term]/$row2[course_id]/index.htm") || is_file("../../echistory/$row2[year]/$row2[term]/$row2[course_id]/index.doc") || is_file("../../echistory/$row2[year]/$row2[term]/$row2[course_id]/index.pdf") || is_file("../../echistory/$row2[year]/$row2[term]/$row2[course_id]/index.ppt") )
						{
							$color = "#E6FFFC";
							$color2= "#E6FFFC";
							$fontcol = "black";
