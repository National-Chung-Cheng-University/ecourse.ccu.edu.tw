...
<!-- BEGIN DYNAMIC BLOCK: comment -->
  ...
  <table width="883" border="0">
    ...
    <tr>
      <td>科目：CID</td>
      <td width="361">CNAME</td>
      <td colspan="2">班別：GID　學分數：CREDIT</td>
    </tr>
    <tr>
      <td>教師：TEACHER</td>
      <td colspan="3"><span class="style6">此為成績列印預覽，非正式成績單，請務必用上傳功能上傳成績</span></td>
    </tr>
  </table>
  <table width="953" border="0">
    <tr>
      <td width="570">(修課人數：STD　)</td>
      <td width="194">本表共TOTAL頁　第
