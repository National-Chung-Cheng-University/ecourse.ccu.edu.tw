...
function printPage() {
if (window.print) {
agree = confirm('本表共TOTAL 頁，請按確定後開始列印本頁，並請在喜好設定中選擇A4橫向列印，\n\n若資料超過1頁者，系統在列印時將會自動分頁。');
...
<!-- BEGIN DYNAMIC BLOCK: comment -->
  <table width="882" border="0">
    <tr>
      <td width="642" rowspan="2"><div align="right"><span class="style4">國立中正大學 學期成績登記表</span></div></td>
  ...
  <table width="883" border="0">
    <tr>
      <td width="190"><div align="left">　YEAR學年　第TERM學期 </div></td>
      <td colspan="2">GNAME</td>
      <td width="164"><div align="right">印製日期：DATE</div></td>
    </tr>
    <tr>
      <td>科目：CID</td>
      <td width="361">CNAME (碩士在職專班) </td>
  ...
  <table width="939" border="0">
    <tr>
      <td width="596">(修課人數：STD　)</td>
      <td width="178">本表共TOTAL頁　第
     <!--     <select name="menu1" onChange="MM_jumpMenu('self',this,0)">-->
		  	PLIST
     <!--     </select> -->
	  頁</td>
      <td width="151"><span class="style5">教師簽章：</span></td>
    </tr>
  </table>
